# Building My Spotify Applications in React with Redux, Redux thunk, Babel, Webpack, TypeScript, custom themes, SASS/SCSS, ESLint, JSON server, JEST, Immer and etc.
